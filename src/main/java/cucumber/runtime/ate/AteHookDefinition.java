...
class AteHookDefinition implements HookDefinition {
    ...
    public AteHookDefinition(Method method, String[] tagExpressions, int order, long timeoutMillis, ObjectFactory objectFactory) {
        this.method = method;
